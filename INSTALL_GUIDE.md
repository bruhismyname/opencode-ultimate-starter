...
```
> ⚠️ **Important:** Do not edit `opencode.json` manually yet. Use the file provided in this Starter Kit (Step 4 below) to avoid crashes.
...
> 🛠️ **Troubleshooting:** If you see an error like `Module not found: lib/skills-core.js`, please refer to our fix guide: [guides/FIX_CRASH_AND_BUGS.md](guides/FIX_CRASH_AND_BUGS.md).
